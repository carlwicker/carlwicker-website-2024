      ...
      <div className="flex flex-col gap-32">
        ...
        <div className="xl:w-1/2" data-scroll data-scroll-speed="0.05">
          <LineSplit>
            ...
            experiences with Next.js, React, and TypeScript. I specialize in
            high-performance interfaces, leveraging GSAP, Framer Motion, and
            Three.js for immersive animations and interactions. With TailwindCSS
            and a strong command of JavaScript, I create sleek, responsive, and
            scalable applications that push the boundaries of modern web
            development.
          </LineSplit>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-32 ">
        ...
        <div className="lg:text-[3rem] text-[1.4rem]">
          <div className="" data-scroll data-scroll-speed="0.05">
            <LineSplit>
              Whether it's enhancing user experience through structured layouts
              or elevating brand identity with powerful typography, my design
              approach balances form and function. Each website I create is
              built to not only look great but also provide an effortless and
              engaging experience for the user. By focusing on detail and
              clarity, I help clients make a lasting impression through every
              digital touchpoint.
            </LineSplit>
          </div>
        </div>
